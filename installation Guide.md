...
4. [Installation Guide](#4-installation-guide)  
   1. [Prepare Custom Folders](#4-1-prepare-custom-folders)  
   2. [Enable Windows Features](#4-2-enable-windows-features)  
   3. [Install WSL & Default Distro (Ubuntu)](#4-3-install-wsl--default-distro-ubuntu)  
   4. [Export the Installed Distro](#4-4-export-the-installed-distro)  
   5. [Unregister the Original Distro](#4-5-unregister-the-original-distro)  
   6. [Import to Custom Location on E](#4-6-import-to-custom-location-on-e)
...
wsl --shutdown
    ...
    Explanation: This command shuts down WSL to ensure that all configuration changes are applied upon restart.
...
wsl -d Ubuntu
    ...
    Explanation: This command launches the Ubuntu distribution, which should now log in as the default user.
...
source /home/devuser/.bashrc
    ...
    Explanation: This command ensures that the terminal starts in the user's home directory.
